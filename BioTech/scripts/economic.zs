...
ResearchTable.builder("moneyMining", catMoney) // The second parameter has no use currently
  ...
  .setRewardCommands("/oxygenop core -currency -add @a 0 10")
  .setNoMaxCount()
  .build();
...
ResearchTable.builder("moneyMining2", catMoney)
  ...
  .setRewardCommands("/oxygenop core -currency -add @a 0 100")
  .setNoMaxCount()
  .build();
...
ResearchTable.builder("moneyMining3", catMoney)
  ...
  .setRewardCommands("/oxygenop core -currency -add @a 0 1000")
  .setNoMaxCount()
  .build();
...
ResearchTable.builder("moneyMining4", catMoney)
  ...
  .setRewardCommands("/oxygenop core -currency -add @a 0 10000")
  .setNoMaxCount()
  .build();
...
ResearchTable.builder("moneyMining5", catMoney)
  ...
  .addEnergyCondition(1000000000)
  .setRewardCommands("/oxygenop core -currency -add @a 0 100000")
  .setNoMaxCount()
  .build();