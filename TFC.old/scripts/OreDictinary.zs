...
var scrapFireDragonsteel = <ore:scrapFireDragonsteel>;
    scrapFireDragonsteel.addItems([
	<contenttweaker:dragonsteel_fire_scrap>
	]);

var scrapIceDragonsteel = <ore:scrapIceDragonsteel>;
    scrapIceDragonsteel.addItems([
	<contenttweaker:dragonsteel_ice_scrap>
	]);
